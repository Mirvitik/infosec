...
public class LevelEightScreen extends ScreenAdapter {
    ...
    public LevelEightScreen(MyGdxGame myGdxGame) {
    ...
    public LevelEightScreen(MyGdxGame myGdxGame, float x, float y) {
        this(myGdxGame);
        heroX = x;
        heroY = y;
    }
